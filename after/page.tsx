import BurnButtonBarContainer from "./components/BurnButtonBarContainer";
import BurnStats from "./components/BurnStats";
import BurnpageTopContainer from "./components/BurnpageTopContainer";
import BurnpageTopCont from "./components/BurnpageTopContainer";
import TransactionTableComp from "./components/TransactionTableComp";
...
export const BurnPage = () => {
  ...
  return (
    <div>
        ...
        <BurnpageTopContainer>
          <div className="info_box filled">
            ...
            <BurnButtonBarContainer
              ...
              prettyEthAddress={prettyEthAddress}
      ...
      {/* wrapped TransactionTableStyled inside TransactionTableComp*/}
